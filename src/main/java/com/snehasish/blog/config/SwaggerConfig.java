...
public class SwaggerConfig {
	...
	private ApiInfo getInfo() {
		return new ApiInfo("Blogging Application : A Backend App", "A Backend Application for Blogging", "1.0",
				"Terms of Service",
				new Contact("Snehasish Paul", "https://github.com/snehasishpaul", "weishenpov@gmail.com"),
